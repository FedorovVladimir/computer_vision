...
public class AlgorithmLine implements Algorithm {
    ...
    public void change(Mat img) {
        line(img, new Point(0, 0), new Point(img.width(), img.height()), new Scalar(0, 0, 255), 10, Imgproc.LINE_AA, 0);
        line(img, new Point(0, img.height()), new Point(img.width(), 0), new Scalar(0, 0, 255), 10, Imgproc.LINE_AA, 0);
